...
var vivienda = {
    "Casas":[{
        "Casa": "Casa con patio grande"
    },
    {
        "Casa": "Casa con patio pequeño"
    },
    {
        "Casa": "Casa sin patio"
    },
...
var txtVivienda = document.getElementById("txtVivienda")

for(let i in vivienda.Casas){
    let option = document.createElement("option")
    option.innerHTML = vivienda.Casas[i].Casa;
    txtVivienda.appendChild(option)
}